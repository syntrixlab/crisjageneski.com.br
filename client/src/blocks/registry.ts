...
export const blockRegistry: Record<BlockType, BlockConfig> = {
  ...
  button:         { label: 'Botão',           defaultData: buttonDefault,      renderer: ButtonRenderer as BlockConfig['renderer'],         form: ButtonBlockForm as BlockConfig['form'] },
  ...
  buttonGroup:    { label: 'Grupo de Botões', defaultData: buttonGroupDefault, renderer: ButtonGroupRenderer as BlockConfig['renderer'],    form: ButtonGroupBlockForm as BlockConfig['form'] },
